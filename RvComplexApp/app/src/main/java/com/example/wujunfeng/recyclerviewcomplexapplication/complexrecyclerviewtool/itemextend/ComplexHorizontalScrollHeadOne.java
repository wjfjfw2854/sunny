...
public class ComplexHorizontalScrollHeadOne extends ItemBaseComplexRecycler {
    ...
    public ComplexHorizontalScrollHeadOne(View itemView, LayoutInflater inflater, Object[] args) {
