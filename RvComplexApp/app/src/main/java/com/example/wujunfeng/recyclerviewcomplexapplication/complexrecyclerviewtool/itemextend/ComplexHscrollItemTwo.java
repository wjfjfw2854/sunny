...
public class ComplexHscrollItemTwo extends ItemBaseComplexRecycler {
    ...
    public ComplexHscrollItemTwo(View itemView, LayoutInflater inflater, Object[] args) {
    ...
    public void initView() {
        ...
        cellScrollItemLeft.initSmalls(scrollHelper.spaceLeftOne);
        cellScrollItemRight.initSmalls(scrollHelper.spaceRightOne);
    ...
    public void bindData(Object data, int pos) {
        ...
        if(data instanceof DataReflect) {
            ...
            if(dataReflect.type == RvItemDataType.TYPE_TOP0) {
                ...
                scrollHelper.cellOuts2.add(celloutItem);
