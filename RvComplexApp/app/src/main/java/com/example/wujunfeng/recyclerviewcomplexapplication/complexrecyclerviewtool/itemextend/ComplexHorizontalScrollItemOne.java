...
public class ComplexHorizontalScrollItemOne extends ItemBaseComplexRecycler {
    ...
    public ComplexHorizontalScrollItemOne(View itemView, LayoutInflater inflater, Object[] args) {
